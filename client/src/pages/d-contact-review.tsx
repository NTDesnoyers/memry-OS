...
export default function DContactReview() {
  ...
  return (
    <LayoutComponent>
      <div className="space-y-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold">D Contact Review</h1>
          <p className="text-muted-foreground">Develop or Delete - Review your D segment contacts</p>
        </div>
